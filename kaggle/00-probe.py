"""Kaggle kernel: measure MiniG's real throughput. Paste THIS into the notebook.
...
What to look for in the output:
  ...
  MicroG (kotwica) should come back near 16,800 tok/s at micro-batch 8. It is
  there to prove the measurement, not the model — if this figure is far off,
  distrust the second line too.

  MiniG (docelowy) should hold micro-batch 8 with peak memory under ~13GB. If
